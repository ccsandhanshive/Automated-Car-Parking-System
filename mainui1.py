...
"color: rgb(0, 0, 255);")
        ...
        self.full_demo = QtWidgets.QPushButton(self.centralwidget)
        self.full_demo.setGeometry(QtCore.QRect(590, 40, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(6)
        self.full_demo.setFont(font)
        self.full_demo.setObjectName("full_demo")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.full_demo.setText(_translate("MainWindow", "full demo"))
